...
<div class="wrap">
	...
	<div id="content">
		...
		<div class="main-content">
      	...
      	<track label="English" kind="captions" srclang="en" src="resources/vtt/sintel-captions-de.vtt">
      ...
      <p>It appears that your browser doesn't support HTML5 video. Here's a <a href="resources/video/sintel-short.mp4">direct link to the video instead</a>.</p>
		  ...
		  <track label="English" kind="subtitles" srclang="en" src="resources/vtt/sintel-test1.vtt" default>
      	<track label="English" kind="captions" srclang="en" src="resources/vtt/sintel-captions-de.vtt">
		...
		<script type="text/javascript">
			...
			function startConverting1 () {
				if('webkitSpeechRecognition' in window){
					...
					speechRecognizer.onresult = function(event){
						var interimTranscripts = '';
						var str = "GateKeeper";	/* chỉnh lại từ cho khớp */
						for(var i = event.resultIndex; i < event.results.length; i++){
							var transcript = event.results[i][0].transcript;
							transcript.replace("\n", "<br>");
							if(event.results[i].isFinal){
